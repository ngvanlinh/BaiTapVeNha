...
public class ProductService implements ProductRepo {
    ...
    public void insertProduct(Product product){
        ...
        try (Connection connection = DatabaseConnection.getConnection();
            ...
            preparedStatement.setInt(4,product.getCat_id());
    ...
    public void searchProductName(String nameProduct) {
        String query = "select * from Product where nameProduct = ? or nameProduct like '%t%' or nameProduct like '%b%';";
    ...
    public void searchCategoryName(String nameCategory) {
        String query = " select cat.nameCategory,pr.nameProduct,pr.price,pr.cat_id from Product pr inner join Category cat where cat.nameCategory = ? and pr.cat_id = cat.id;";
